...
<head>
  ...
  <title>autolavados.cl — Iniciar sesión</title>
  <style>
    * { box-sizing: border-box; }
    ...
    button {
      ...
      background: #0081ff; color: #fff; font-size: 1rem; font-weight: 600; cursor: pointer;
    }
...
<body>
  <div class="card">
    <h1>autolavados.cl</h1>
    <p class="sub">API — Iniciar sesión</p>
    <div id="err" class="err"></div>
    <form id="form">
      <label for="email">Correo</label>
      <input id="email" type="email" value="admin@autolavados.cl" required autocomplete="username" />
